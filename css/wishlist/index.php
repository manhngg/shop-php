                        ...
                        <div class="col-8">
                            ...
                            <div class="container cart-head-container clearfix">
                                <div class="col-4 title-wrapper" data-scope="breadcrumbs" data-context="home;shopping cart">
                                    <h1 class="checkout-title">DANH SÁCH YÊU THÍCH của bạn trống</h1>
                            ...
                            <div class="contionue-shopping-wrapper">
                                <form class="co-formcontinueshopping" action="https://www.adidas.com/on/demandware.store/Sites-adidas-US-Site/en_US/Cart-Show/C1562178392" method="post" id="dwfrm_cart_d0bmfvnqlzbu">
                                    <fieldset>
                    ...
                    <div class="certona-cart-recommendation products-carousel">
                        ...
                        <div data-certonazoneid="emptycart_rr" class="owlcarousel-wrapper product-carousel-owl fullwidth" data-component="productlist/Plp">
                            <div class="owl-carousel owl-theme" data-component="common/OwlCarousel" data-prop-nesteditemselector="hockeycard" data-prop-nav="true" data-prop-items="4.0" data-prop-slideBy="4.0" data-prop-margin="10">
                                ...
                                <img class="loading-small" src="https://www.adidas.com/static/on/demandware.static/Sites-adidas-US-Site/-/default/dwba17e999/images/loading-small.gif" alt="" />
                ...
                <div class="col-8">
                    <!-- START products wrapper -->
                        <div class="container clearfix">
                            ...
                            <div class="col-4 title-wrapper" data-scope="breadcrumbs" data-context="home;shopping cart">
                                <h1 class="checkout-title">DANH SÁCH YÊU THÍCH
                                <span>
                                                ...
                                                <div class="detailscolumn">
                                                    ...
                                                    <div class="product" data-id="CP9797_540">
                                                        ...
                                                        <div class="co-product-actions">
															<form action="/vn/wishlist/xulyxoa.php?slot=<?php echo $row['IDSP'] ?>" method="post" enctype="multipart/form-data">
                                                            <button type="submit"><span>Xóa</span>
                                                            <form action="/vn/wishlist/xulythem.php?slot=<?php echo $row['IDSP'] ?>" method="post" enctype="multipart/form-data">
